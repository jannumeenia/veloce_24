...
layout = [
     ...
     sg.Text('', size=(8, 1), font=('Helvetica', 10), justification='right', key='lv_blank', background_color='black', text_color='white'),
     sg.Text('',pad = ((0,0),(20,0)), size=(2, 1), font=('Helvetica', 202), justification='center', key='wheel_speed', background_color='black', text_color='red'),
     ...
     sg.Text('', size=(4, 1), font=('Helvetica', 40), justification='center', key='motor_rpm', background_color='black', text_color='#6924ad'),
     ],
     
    [sg.Text('', size=(1, 1), font=('Helvetica', 10), justification='center', key='-DUMMY4-', background_color='black', text_color='black'),
     ],

     [ sg.Text('', size=(3, 1), font=('Helvetica', 45), justification='center', key='hv', background_color='black', text_color='blue'),
      sg.Text('⚡', size=(1, 1), font=('Helvetica',25), justification='center', key='hv_bolt_symbol', background_color='black', text_color='blue'),
      sg.Text('', size=(14, 1), font=('Helvetica', 40), justification='center', key='bottom_blank', background_color='black', text_color='black'),
    ...
    [ 
     ...
     sg.Text('', size=(11, 1), font=('Helvetica', 40), justification='center', key='bottom_blank', background_color='black', text_color='black'),
